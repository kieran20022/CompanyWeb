...
const steps = [
  ...
  },
  {
    ...
    description:
      "Our team creates a custom design, writes your copy, and builds a fast, modern website — ready for your review.",
  },
  {
    icon: Rocket,
    number: "03",
          ...
          {steps.map((step, i) => (
            <FadeIn key={step.number} delay={i * 0.15}>
              <div className="relative text-center md:text-left">
                <div className="mb-6 inline-flex items-center justify-center rounded-xl bg-white p-4 shadow-sm">
